const url_vue = "https://qiita.com/api/v2/items?page=1&per_page=3&query=tag:Vue.js"
const url_node = "https://qiita.com/api/v2/items?page=1&per_page=3&query=tag:node.js"
const url_js = "https://qiita.com/api/v2/items?page=1&per_page=3&query=tag:JavaScript"

var data_vue = {}
var data_node = {}
var data_js = {}

axios.get(url_vue).then((res) => {
